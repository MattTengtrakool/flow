...
function recurrenceForState(
  state: CalendarEditorState,
): CreateCalendarItemInput['recurrence'] {
          ...
          <form className="calendar-editor" onSubmit={submitEditor}>
            ...
            <label className="form-field calendar-editor__title">
              ...
              <input
                ...
                placeholder={
                  editorState.kind === 'task' ? 'Task name' : 'Event name'
                }
              />
            </label>
                ...
                <input
                  ...
                  onChange={event =>
                    setEditorState(previous => ({
                      ...
                      repeatDaysOfWeek:
                        previous.repeat === 'weekly' &&
                        previous.repeatDaysOfWeek.length <= 1
            ...
            {editorError != null ? (
              <p className="calendar-editor__error">{editorError}</p>
            ) : null}
